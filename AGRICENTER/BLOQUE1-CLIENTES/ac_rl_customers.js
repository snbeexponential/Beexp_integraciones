    ...
    const createOrUpdateCustomer = (fixed_request) => {
        ...
        var user_data = {
            ...
            addressbook:[
                          {
                addressbookaddress: {
                  country: fixed_request.pais,
                  addressee:fixed_request.propietario,
                  addrphone: fixed_request.numero_direccion,
                  addr1: fixed_request.calle1,
                  addr2: fixed_request.calle2,
                  city: fixed_request.ciudad,
                  state: fixed_request.estado,
                  zip:fixed_request.codigo_postal,
                  notedirectiontype: fixed_request.notas
